                    ...
                    <?php
                        if(isset($_SESSION['giohang'])){
                            ...
                            foreach($_SESSION['giohang'] as $item_giohang){
                                ...
                                <tr>
                                    <th scope="row">'.$i.'</th>
                                    <td><img src="../admin/uploads/'.$item_giohang['TenHinh'].'" style="width: 150px; height: 200px;" alt=""></td>
                                    <td>'.$item_giohang['tensach'].'</td>
                                    <td>'.$item_giohang['giasach'].'</td>
                                    <td>'.$item_giohang['soluong'].'</td>
                                    <td>'.$item_giohang['tientong'].'</td>
                                    <td>
                                        <form action="./process_giohang.php?mshhXoa='.$item_giohang['tientong'].'" method="POST">
                                            <input class="btn btn-secondary btn-sm" style="margin: 0px 0px 20px 200px;" name="Xoahh" type="submit" value="Xoa">
                                        </form>
                                    </td>
                                </tr>';
                                $i++;
