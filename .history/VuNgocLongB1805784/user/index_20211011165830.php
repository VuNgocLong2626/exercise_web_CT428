            ...
            <div class="from-individual">
                ...
                <?php 
                    if (isset($_SESSION['username_dangnhap'])){
                        echo '<a href="./process/process_dangnhap_dangxuat.php?process=0" class="btn btn-outline-secondary" style="margin-right: 20px; ">Logout</a>';
                        echo $_SESSION['username_dangnhap'];
                    }
                    else{
                        echo '<a href="./process/process_dangnhap_dangxuat.php?process=1" class="btn btn-outline-secondary" style="margin-right: 20px; ">Login</a>
                            <a href="./process/process_dangnhap_dangxuat.php?process=2" class="btn btn-outline-secondary" style="margin-right: 20px; ">Register</a>';
                    }
                ?>
            </div>
        </div>
