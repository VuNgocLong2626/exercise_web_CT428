            ...
            <div class="from-individual">
                ...
                <?php 
                    if (isset($_SESSION['username_dangnhap'])){
                        ...
                        echo '<a href="process_dangnhap_dangxuat.php?process=0" class="btn btn-outline-secondary" style="margin-right: 20px; ">Đăng Nhập</a>
                            <a href="" class="btn btn-outline-secondary" style="margin-right: 20px; ">Đăng ký</a>';
                    }
                ?>
            </div>
        </div>
