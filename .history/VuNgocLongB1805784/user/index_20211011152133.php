    ...
    <div class="main-contens">
        ...
        <div class="all-products">
            <nav>
                ...
                ?>
                <button type="button" class="btn btn-outline-secondary">Tất cả sách</button>
                <button type="button" class="btn btn-outline-secondary">Tiểu thuyết</button>
                <button type="button" class="btn btn-outline-secondary">Khoa học</button>
                <button type="button" class="btn btn-outline-secondary">Tiểu thuyết</button>
                <button type="button" class="btn btn-outline-secondary">Tâm lý</button>
                <button type="button" class="btn btn-outline-secondary">Thiếu nhi</button>
            </nav>
            <div class="products">
                <div class="books">
