                        ...
                        echo '<div class="books">
                                <div class="card" style="width: 100%; border: none; background-color: #f1f1f1;">
                                    ...
                                    <div class="card-body" style="font-size: 13px;">
                                        <h6 class="card-title">' .$row["TenLoaiHang"]. '</h6>
                                        <p>' .$row["TenLoaiHang"]. '</p>
                                        <div style="display: flex;">
                                            <a href="' .$row["TenLoaiHang"]. '" class="btn btn-secondary btn-sm" style="margin-right: 10px;padding: 0px;width: 200px;">Chi tiết sản phẩm</a>
