...
<body>
    <div class="main-contens">
        ...
        <div class="all-products">
            <nav>
                <a href="" class="btn btn-outline-secondary" style="margin: auto 20px;padding-top: 12px;">Tất cả sách</a>
                <?php 
                $result = $conn->query("SELECT * FROM loaihanghoa");
                $i=1;
                while($row = $result->fetch_assoc()){
                    echo '<a href="" class="btn btn-outline-secondary" style="margin: auto 20px;padding-top: 12px;">'.$row["TenLoaiHang"].'</a>';
                }
                ?>
            </nav>
            <div class="products">
