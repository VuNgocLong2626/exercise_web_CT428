        ...
        <div class="all-products">
            <nav>
                ...
                while($row = $result->fetch_assoc()){
                    echo '<a href="'.$row["TenLoaiHang"].'" class="btn btn-outline-secondary" style="margin: auto 15px;padding-top: 12px;">'.$row["TenLoaiHang"].'</a>';
                }
                ?>
            </nav>
            <div class="products">
                <?php 
                    $result = $conn->query("SELECT * FROM hanghoa hh JOIN hinhminhhoa hmh ON hh.MSHH = hmh.MSHH");
                    $i=1;
                    while($row = $result->fetch_assoc()){
