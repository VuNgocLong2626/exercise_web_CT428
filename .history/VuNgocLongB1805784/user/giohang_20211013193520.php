                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="./process_giohang.php?mshhXoa='.$item_giohang['msx'].'" method="POST">
                                            <input class="btn btn-secondary btn-lg" name="Xoahh" type="submit" value="Xoa">
                                            <br>
                                            <input class="btn btn-secondary btn-lg" style="margin-top: 20px;" name="Xoahh" type="submit" value="Xoa">
                                            <br>
                                            <input class="btn btn-secondary btn-lg" style="margin-top: 20px;" name="Xoahh" type="submit" value="Xoa">
                                        </form>
                                    </td>
