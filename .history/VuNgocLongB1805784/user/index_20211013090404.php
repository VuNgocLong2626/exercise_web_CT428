                ...
                <?php 
                    ...
                    while($row = $result->fetch_assoc()){
                        echo '<div class="books">
                                <form action="./process/process_giohang.php?mshh='.$row["MSHH"].'">
                                    <div class="card" style="width: 100%; border: none; background-color: #f1f1f1;">
                                        ...
                                        <div class="card-body" style="font-size: 13px;">
                                            ...
                                            <div style="display: flex;">
                                                <a href="chitiethanghoa.php?mshh=' .$row["MSHH"]. '" class="btn btn-secondary btn-sm" style="margin-right: 10px; padding: 8px 0px;width: 200px;">Chi tiết sách</a>
                                                <a href="#" class="btn btn-secondary btn-sm" style="width: 200px; padding-top: 8px;">Thêm vào giỏ</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <form action="">
                        <div class="card" style="width: 100%; border: none; background-color: #f1f1f1;">
                            ...
                            <div class="card-body" style="font-size: 13px;">
                                ...
                                <p>190.000 vnđ</p>
                                <div style="display: flex;">
                                    <a href="#" class="btn btn-secondary btn-sm" style="margin-right: 10px;padding: 1.75px 0px;;width: 200px;">Chi tiết sách</a>
                                    <input class="btn btn-secondary btn-sm" style="width: 200px; padding-top: 8px;" name="themgiohang" type="submit" value="Thêm giỏ hàng">
                                </div>
                            </div>
                        </div>
                    </form>
