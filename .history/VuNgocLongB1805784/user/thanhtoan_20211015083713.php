<div class="all-cart">
    ...
    <?php
        ...
        <form name="xacnhandathang" method="post" action="">
            ...
            <button type="submit" class="btn btn-secondary btn-lg" style="margin: 50px 500px;" name="xacnhan" id="xacnhan" onmouseover="CheckDN('.$row['HoTenKH'].')">Xác nhận đặt hàng</button>
        </form>
        ';
    ?>
