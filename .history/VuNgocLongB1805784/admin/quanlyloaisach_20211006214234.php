...
<?php
    ...
    while($row = $result->fetch_assoc()){
        echo '<tr>
                ...
                <th scope="col">
                <a class="btn btn-secondary btn-size" href="quanlyloaisach.php">Thêm Sản Phẩm</a>
                <a class="btn btn-secondary btn-size" href="quanlyloaisach.php">Quản lý loại sách</a>
                </th>
            <tr>';
            $i++;
    }
