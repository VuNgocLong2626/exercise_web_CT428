...
<?php
    ...
    while($row = $result->fetch_assoc()){
        echo '<tr>
                ...
                <th scope="col">
                <a class="btn btn-secondary btn-size-s" href="quanlyloaisach.php">Xóa</a>
                <a class="btn btn-secondary btn-size-s" href="quanlyloaisach.php?sua=' .<?php echo $row["MaLoaiHang"]; ?>. '">Sửa</a>
                </th>
            <tr>';
            $i++;
    }
