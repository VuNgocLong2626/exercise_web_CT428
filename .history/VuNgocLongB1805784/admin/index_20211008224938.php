...
<body>
    <header>
        ...
        <a class="btn btn-outline-secondary" style="margin-right: 20px; float:right;">Đăng xuất</a>
    </header>

    <div class="row" style="max-width: 1900px;">
        <div class="col-3" style="height: 200px;">
            <div class="d-grid gap-2">
                <a class="btn btn-secondary btn-size" href="index.php?action=themsach">Thêm Sách</a>
