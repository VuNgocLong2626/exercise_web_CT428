    ...
    while($row = $result->fetch_assoc()){
        ...
        <form name="quanlyloai" method="post" action="process/process_xacnhandon.php">
            <tr>
                ...
                <th scope="col">
                    <button class="btn btn-secondary btn-size-s" style="display: block;">Sửa</button>
                    <button class="btn btn-secondary btn-size-s" style="display: block;margin-top: 20px;">Sửa</button>
                    <button class="btn btn-secondary btn-size-s" style="display: block;margin-top: 20px;">Sửa</button>
                </th>
            </tr>
        </form>
