<div class="from-sach">
    <form name="quanlysach" method="post" action="process/process_quanlysach.php" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-secondary" name="themsach" onmouseover="">Thêm Sách</button>
        <button type="submit" class="btn btn-secondary" name="capnhatsach" onmouseover="">Cập nhật Sách</button>
    </form>
</div>
