    ...
    while($row = $result->fetch_assoc()){
        ...
        <form name="quanlyloai" method="post" action="process/process_xacnhandon.php">
            <tr>
                ...
                <th scope="col">
                    <button class="btn btn-secondary btn-size-s" style="display: block;" name="dangxl">Đang xử lý</button>
                    <button class="btn btn-secondary btn-size-s" style="display: block;margin-top: 5px;"name="daht">Đã Hoàn Thành</button>
                    <button class="btn btn-secondary btn-size-s" style="display: block;margin-top: 5px;">Sửa</button>
                </th>
            </tr>
        </form>
        ';
