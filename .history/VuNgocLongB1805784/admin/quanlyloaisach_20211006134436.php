...
<div class="from-loai">
    <form name="quanlyloai" method="post" action="process/process_quanlyloai.php">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" value="maloai">
        </div>
        <div class="mb-3">
            <label for="" class="form-label">Tên Loại</label>
            <input type="text" class="form-control" value="tenloai">
        </div>
        <button type="submit" class="btn btn-secondary">Thêm Loại</button>
    </form>
</div>