...
function validate() {
  if (checkNull(tk.value) || checkNull(pass1.value) || checkNull(cpass.value) || checkNull(ho.value) || checkNull(ten.value) || checkNull(email.value) || checkNull(sdt.value)) {
    ...
    if (checkTk(tk.value)) {
      ...
      if (checkMk(pass1.value, tk.value)) {
        ...
        if (!checkMk2(pass1.value, cpass.value)) {
