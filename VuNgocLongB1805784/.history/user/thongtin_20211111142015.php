<div class="all-cart">
    ...
    <?php
        ...
        echo '
        <form name="thongtincanhan" method="post" action="process/process_dangnhap_dangxuat.php">
            <div class="mb-3 row">
            ...
            <button type="submit" class="btn btn-secondary btn-lg" style="margin: 50px 500px;" name="capnhat" id="capnhat">Cập nhật</button>
        </form>
        ';
    ?>
    <hr>
