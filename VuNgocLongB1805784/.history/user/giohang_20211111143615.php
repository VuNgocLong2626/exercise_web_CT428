                ...
                if(isset($_SESSION['giohang'])){
                    ...
                    foreach($_SESSION['giohang'] as $item_giohang){
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="process/process_giohang.php?mshhXoa='.$item_giohang['msx'].'" method="POST">
                    ...
                    echo '
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="process/process_giohang.php" method="POST">
